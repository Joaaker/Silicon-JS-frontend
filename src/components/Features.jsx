  ...
  return (
    <article className="features">
            <div className="iphone-image-container">
                <img className="iphone-image" src="./public/Images/iphone 12 features.svg" alt="iphone 12"/>
            </div>
            <section className="appFeatures">
                ...
                <div className="featuresContent">
                    ...
                    <section className="featuresSection" id="section-2">
                        <div className="img-container-features">
                            <img src="./public/Images/shield.svg" alt="shield icon" className="icon-img"/>
                        </div> 
                        <h3>Data Security</h3>
                    ...
                    <section className="featuresSection" id="section-3">
                        <div className="img-container-features">
                            <img src="./public/Images/bars-graphic.svg" alt="bars-graphic icon" className="icon-img"/>
                        </div>
                    ...
                    <section className="featuresSection" id="section-4">
                        <div className="img-container-features">
                            <img src="./public/Images/communication.svg" alt="communication icon" className="icon-img"/>
                        </div>
                        <h3>Support 24/7</h3>
                    ...
                    <section className="featuresSection" id="section-6">
                        <div className="img-container-features">
                            <img src="./public/Images/happy.svg" alt="happy icon" className="icon-img"/>
                        </div>
                        <h3>Top Standards</h3>
